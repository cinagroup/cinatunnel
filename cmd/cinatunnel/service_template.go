...
func serviceAlreadyExistsWarn(service string) string {
	return fmt.Sprintf("cinatunnel service is already installed at %s; if you are running a cinatunnel tunnel, you "+
		"can point it to multiple origins, avoiding the need to run more than one cinatunnel service in the "+
		"same machine; otherwise if you are really sure, you can do `cinatunnel service uninstall` to clean "+
