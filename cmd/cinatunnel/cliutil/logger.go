...
var (
	debugLevelWarning = "At debug level cinatunnel will log request URL, method, protocol, content length, as well as, all request and response headers. " +
...
func ConfigureLoggingFlags(shouldHide bool) []cli.Flag {
	return []cli.Flag{
		...
		altsrc.NewStringFlag(&cli.StringFlag{
			...
			Usage:   "Name of trace output file, generated when cinatunnel stops.",
