...
const (
	// OSKeyName is the url parameter key to send to the checkin API for the operating system of the local cinatunnel (e.g. windows, darwin, linux)
	OSKeyName = "os"

	// ArchitectureKeyName is the url parameter key to send to the checkin API for the architecture of the local cinatunnel (e.g. amd64, x86)
	...
	// ClientVersionName is the url parameter key to send the version that this cinatunnel is currently running with
