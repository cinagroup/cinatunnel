...
const (
	baseLoginURL         = "https://dash.cinatunnel.com/argotunnel"
	callbackURL          = "https://login.cinatunnel.com/"
	fedBaseLoginURL      = "https://dash.fed.cinatunnel.com/argotunnel"
	fedCallbackStoreURL  = "https://login.fed.cinatunnel.com/"
...
var (
	loginURL = &cli.StringFlag{
		...
		Value: baseLoginURL,
		Usage: "The URL used to login (default is https://dash.cinatunnel.com/argotunnel)",
	}
	callbackStore = &cli.StringFlag{
		Name:  callbackURLParamName,
		Value: callbackURL,
		Usage: "The URL used for the callback (default is https://login.cinatunnel.com/)",
	}
