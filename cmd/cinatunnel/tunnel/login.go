...
const (
	baseLoginURL         = "https://dash.cina.com/argotunnel"
	callbackURL          = "https://login.cinaaccess.org/"
	fedBaseLoginURL      = "https://dash.fed.cina.com/argotunnel"
	fedCallbackStoreURL  = "https://login.fed.cinaaccess.org/"
...
var (
	loginURL = &cli.StringFlag{
		...
		Value: baseLoginURL,
		Usage: "The URL used to login (default is https://dash.cina.com/argotunnel)",
	}
	callbackStore = &cli.StringFlag{
		Name:  callbackURLParamName,
		Value: callbackURL,
		Usage: "The URL used for the callback (default is https://login.cinaaccess.org/)",
	}
