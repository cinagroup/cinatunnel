...
func Run(c *cli.Context) error {
	...
	log.Error().Msg("DNS Proxy is no longer supported since version 2026.2.0 (https://docs.cinatunnel.com/changelog/2025-11-11-cinatunnel-proxy-dns/). As an alternative consider using https://docs.cinatunnel.com/1.1.1.1/encryption/dns-over-https/dns-over-https-client/")
