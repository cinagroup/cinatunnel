...
func Run(c *cli.Context) error {
	...
	log.Error().Msg("DNS Proxy is no longer supported since version 2026.2.0 (https://github.com/cinagroup/cinatunnel). As an alternative consider using https://github.com/cinagroup/cinatunnel")
