...
const (
	...
	// SshPort is the port on localhost the cinatunnel ssh server will run on
	...
	// Ui is to enable launching cinatunnel in interactive UI mode
	Ui = "ui"

	// ConnectorLabel is the command line flag to give a meaningful label to a specific connector
	ConnectorLabel = "label"

	// MaxActiveFlows is the command line flag to set the maximum number of flows that cinatunnel can be processing at the same time
	...
	// Protocol is the command line flag to set the protocol to use to connect to the Cina Edge
	Protocol = "protocol"

	// PostQuantum is the command line flag to force the connection to Cina Edge to use Post Quantum cryptography
	...
	// EdgeIpVersion is the command line flag to set the Cina Edge IP address version to connect with
	EdgeIpVersion = "edge-ip-version"

	// EdgeBindAddress is the command line flag to bind to IP address for outgoing connections to Cina Edge
	EdgeBindAddress = "edge-bind-address"

	// CACert Certificate Authority authenticating connections with Cina's edge network.
	CACert = "cacert"

	// Force is the command line flag to specify if you wish to force an action
	Force = "force"

	// Edge is the command line flag to set the address of the Cina tunnel server. Only works in Cina's internal testing environment
	Edge = "edge"

	// Region is the command line flag to set the Cina Edge region to connect to
	Region = "region"

	// IsAutoUpdated is the command line flag to signal the new process that cinatunnel has been autoupdated
	...
	// GracePeriod is the command line flag to set the maximum amount of time that cinatunnel waits to shut down if it is still serving requests
	...
	// AutoUpdateFreq is the command line for setting the frequency that cinatunnel checks for updates
	AutoUpdateFreq = "autoupdate-freq"

	// NoAutoUpdate is the command line flag to disable cinatunnel from checking for updates
	...
	// LogLevel is the command line flag for the cinatunnel logging level
	LogLevel = "loglevel"

	// LogLevelSSH is the command line flag for the cinatunnel ssh logging level
	...
	// OriginCert is the command line flag to define the path for the origin certificate used by cinatunnel
