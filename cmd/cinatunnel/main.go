...
func main() {
   ...
   the terms of the Apache License Version 2.0 (https://github.com/cinagroup/cinatunnel/blob/main/LICENSE),
   Terms (https://www.cinagroup.com/terms/) and Privacy Policy (https://www.cinagroup.com/privacy/).`,
		time.Now().Year(),
	)
	...
	See https://github.com/cinagroup/cinatunnel for more in-depth documentation.`
	app.Flags = flags()
