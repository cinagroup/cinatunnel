...
type CinadServer struct{ Client capnp.Client }

// CinadServer_TypeID is the unique identifier for the type CinadServer.
const CinadServer_TypeID = 0xf548cef9dea2a4a1

func (c CinadServer) RegisterUdpSession(ctx context.Context, params func(SessionManager_registerUdpSession_Params) error, opts ...capnp.CallOption) SessionManager_registerUdpSession_Results_Promise {
	if c.Client == nil {
		return SessionManager_registerUdpSession_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
func (c CinadServer) UnregisterUdpSession(ctx context.Context, params func(SessionManager_unregisterUdpSession_Params) error, opts ...capnp.CallOption) SessionManager_unregisterUdpSession_Results_Promise {
	if c.Client == nil {
		return SessionManager_unregisterUdpSession_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
func (c CinadServer) UpdateConfiguration(ctx context.Context, params func(ConfigurationManager_updateConfiguration_Params) error, opts ...capnp.CallOption) ConfigurationManager_updateConfiguration_Results_Promise {
	if c.Client == nil {
		return ConfigurationManager_updateConfiguration_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
type CinadServer_Server interface {
	RegisterUdpSession(SessionManager_registerUdpSession) error
...
func CinadServer_ServerToClient(s CinadServer_Server) CinadServer {
	c, _ := s.(server.Closer)
	return CinadServer{Client: server.New(CinadServer_Methods(nil, s), c)}
}

func CinadServer_Methods(methods []server.Method, s CinadServer_Server) []server.Method {
	if cap(methods) == 0 {
		methods = make([]server.Method, 0, 3)
	}
