...
func Test_rule_matches(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			rule: Rule{
				Hostname:         "môô.cinatunnel.com",
				punycodeHostname: "xn--m-xgaa.cinatunnel.com",
			},
			args: args{
				requestURL: MustParseURL(t, "https://môô.cinatunnel.com"),
			},
			want: true,
		},
		{
			...
			args: args{
				requestURL: MustParseURL(t, "https://xn--m-xgaa.cinatunnel.com"),
			},
			want: true,
		},
		{
