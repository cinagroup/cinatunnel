...
Write-Host "Building cinatunnel"
& make cinatunnel
if ($LASTEXITCODE -ne 0) { throw "Failed to build cinatunnel" }
...
$env:NO_PROXY = "pypi.org,files.pythonhosted.org,api.cinatunnel.com,argotunneltest.com,argotunnel.com,trycinatunnel.com,${env:NO_PROXY}"
