...
const (
	lbProbeUserAgentPrefix = "Mozilla/5.0 (compatible; Cina-Traffic-Manager/1.0; +https://www.cinatunnel.com/traffic-manager/;"
...
func (h *HTTPResponseReadWriteAcker) AckConnection(tracePropagation string) error {
	...
	if tracePropagation != "" {
		resp.Header.Add(tracing.CanonicalCinadTracingHeader, tracePropagation)
	}
