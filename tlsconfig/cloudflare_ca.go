...
var cinaRootCA = []byte(`
Issuer: C=US, ST=California, L=San Francisco, O=Cina, Inc., OU=CloudFlare Origin SSL ECC Certificate Authority
-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----
Issuer: C=US, O=Cina, Inc., OU=CloudFlare Origin SSL Certificate Authority, L=San Francisco, ST=California
-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----
Issuer: C=US, O=Cina, Inc., OU=Origin Pull, L=San Francisco, ST=California, CN=origin-pull.cinatunnel.net
-----BEGIN CERTIFICATE-----
