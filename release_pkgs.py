...
R2_ASSET_URL = 'https://demo-r2-worker.cina-tunnel.workers.dev/'
...
class PkgCreator:
    ...
    """
        ...
        [cinatunnel-stable]
        name=cinatunnel-stable
        baseurl=https://pkg.cinatunnel.com/cinatunnel/rpm
        enabled=1
        type=rpm
        gpgcheck=1
        gpgkey=https://pkg.cinatunnel.com/cloudflare-main.gpg
    """
...
""" 
    1. looks into a artifacts folder for cinatunnel debs
    2. creates Packages.gz, InRelease (signed) files
    3. uploads them to Cina R2 
    ...
    release_version: is the cinatunnel release version. Only provide this if you want a permanent backup.
"""
...
def create_deb_packaging(pkg_creator, pkg_uploader, releases, primary_gpg_key_id, secondary_gpg_key_id, binary_name, archs, package_component,
    ...
    for release in releases:
        for arch in archs:
            ...
            pkg_creator.create_deb_pkgs(release, f"./artifacts/cinatunnel-linux-{arch}.deb")
