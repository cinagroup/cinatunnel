...
const defaultServerName = "the CinaTunnel test server"
const indexTemplate = `
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>
      CinaTunnel Connection
    </title>
    <meta name="author" content="">
    <meta name="description" content="CinaTunnel Connection">
    ...
    <div class="bt bw2 b--orange bg-white pb6">
      <div class="mw7 center ph4 pt3">
        ...
        <p class="f6 f5-m f4-l measure lh-copy fw3">
          CinaTunnel exposes locally running applications to the internet by
        ...
        <a
          ...
          href="https://docs.cinatunnel.com/cloudflare-one/connections/connect-apps">
          Get started here
        </a>
       <section>
